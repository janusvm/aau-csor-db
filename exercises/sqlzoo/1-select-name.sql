 ...
 * characters.  Find the countries that have two "o" characters separated by two
 * others.
 */
SELECT name
  FROM world
 ...
 * capital is the same as the name of the country Find the country where the
 * name is the capital city.
 */
SELECT name
  FROM world
 ...
 * capital has the country together with the word "City".  Find the country
 * where the capital is the country plus "City".
 */
SELECT name
  FROM world
 ...
 * the country.  You should include Mexico City as it is longer than Mexico. You
...
/* 15 --------------------------------------------------------------------------
 * For Monaco-Ville the name is Monaco and the extension is -Ville.  Show the
 * name and the extension where the capital is an extension of name of the
 * country.  You can use the SQL function REPLACE.
 */
SELECT name,
